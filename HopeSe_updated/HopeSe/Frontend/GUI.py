...
class ChatSection(QWidget):
    def __init__(self):
        ...
        movie = QMovie(GraphicsDictonaryPath("HopeSe.jpeg"))
        ...
        self.timer.start(100) # Optimized polling interval
...
class InitialScreen(QWidget):
    def __init__(self, parent=None):
        ...
        self.movie = QMovie(GraphicsDictonaryPath("HopeSe.jpeg"))
        ...
        pixmap = QPixmap(GraphicsDictonaryPath("mic.jpg"))
        ...
        self.video_widget.hide() # Initially hide video
...
#@iteration: 3
    def SpeechRecogText(self):
        with open(TempDictonaryPath("Status.data"), "r", encoding="utf-8") as file:
            ...
            if messages != self.current_status:
                self.current_status = messages
                if "Listening..." in messages:
                    self.update_media("listening.gif")
                elif "Thinking..." in messages:
                    self.update_media("thinking.gif")
                elif "Answering..." in messages:
                    self.update_media("answering.gif")
                else:
                    self.update_media("listening.gif")

    def update_media(self, filename):
        path = GraphicsDictonaryPath(filename)
    ...
    def toggle_icon(self, event=None):
        if self.toggled:
            self.load_icon(GraphicsDictonaryPath("mic.jpg"), 60, 60)
            MicButtonInitialed()
        else:
            self.load_icon(GraphicsDictonaryPath("close mic.png"), 60, 60)
            MicButtonClosed()
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        home_icon = QIcon(GraphicsDictonaryPath("home.jpeg"))
        ...
        message_icon = QIcon(GraphicsDictonaryPath("chat.jpeg"))
        ...
        self.restore_icon = QIcon(GraphicsDictonaryPath("Minimize2.png"))
        ...
        close_icon = QIcon(GraphicsDictonaryPath("close.jpeg"))
